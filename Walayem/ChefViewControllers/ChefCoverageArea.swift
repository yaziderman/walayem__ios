...
class ChefCoverageArea: UIViewController, UITableViewDelegate, UITableViewDataSource {
     ...
     enum ExpandType :String
       ...
       override func viewDidLoad()
       {
           ...
           sectionNames = [ "Abu-Dhabi", "Dubai", "Sharjah", "Ras-Al-Khaima", "UM-Al-Quain", "Fujairah" ]
           
           sectionItems = [ ["Al Wahda", "CityWalk", "SeikhZayedMosque", "Sabiya", "Khalifa city"],
                            ["Burdubai", "Al fahidi", "Roll Street", "AL quoz"],
                            ["Rola Road", "Naif", "CityMall"],["StreetWalk", "RasAlKhoor", "Hills side"],["Area1 ", "Area2", "Area3"],["Area1 ", "Area2", "Area3", "Area4", "Area5"]
                          ]
...
//        if let headerView = tableView.dequeueReusableCell(withIdentifier: "chefcity") as? ChefCityTableViewCell {
//            headerView.cityname.text = self.sectionNames[section] as? String
//
//            return headerView
//        }
//
...
//
       func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
       {
        ...
        if let cell = tableView.dequeueReusableCell(withIdentifier: "tableCell", for: indexPath) as? ChefAreaTabelViewCell {
            ...
            cell.AreaName.text = section[indexPath.row] as? String
       ...
       func tableView(_ tableView: UITableView, willDisplayHeaderView view: UIView, forSection section: Int)
       {
           ...
           chevronImageView.image = UIImage(named: "down")
