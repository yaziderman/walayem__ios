...
class SignupViewController: UIViewController, UITextFieldDelegate, GIDSignInDelegate, ChefCoverageAreaDelegate, LocationSelectionDelegate {
    ...
    @IBOutlet weak var coverageVerifyImageView: UIImageView!
    @IBOutlet weak var locationVerifyImageView: UIImageView!
    ...
    @IBAction func coverageAreaBtnClicked(_ sender: Any) {
        self.selectedAreaIds = nil
        self.selectedEmerates = nil
    ...
    func locationSelected(_ location: Location, title: String, address: UserAddress) {
        ...
        self.locationVerifyImageView.tintColor = .colorPrimary
    }
        ...
        if(!self.isChef)
        {
            ...
            if (session == nil){
                ...
                let params: [String : Any] = ["name": name,
                                              ...
                                              "confirm_password": password,
                                              "is_chef": true,
                                              "areas": self.selectedAreaIds!,
                                              "emirates": self.selectedEmerates ?? [],
                                              "location":["lat": self.selectedLat ?? 0.0,
                                                          "lon": self.selectedLng ?? 0.0]]
